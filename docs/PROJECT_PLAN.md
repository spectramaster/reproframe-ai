...
- [x] Add a model-based visual evaluator behind an explicit provider interface.
...
- [x] Verify asset SHA-256 and Genblaze manifest integrity from a clean environment.

### M3 — product-quality app and evaluation (July 20–25)

- [x] Add run history, attempt comparison, manual acceptance, and downloadable bundle.
- [x] Build at least five representative scientific-communication fixtures.
- [x] Measure claim/label coverage, retry success, latency, cost, and storage integrity.
- [x] Add abuse limits, input bounds, timeouts, structured errors, and privacy controls.
